...
> A production-grade expense management platform built with **.NET 8 microservices**, **React**, **Docker**, and **Clean Architecture** — demonstrating enterprise-level backend engineering.
